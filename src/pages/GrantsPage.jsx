        ...
        {GRANT_TYPES.map((grant, idx) => (
          ...
          >
            <div className={`${grant.colorClass} p-10 text-white relative overflow-hidden`}>
              <div className="absolute -top-5 -right-5 bg-white/10 w-40 h-40 rounded-full blur-3xl group-hover:bg-white/20 transition-colors" />
            ...
            <div className="p-10 flex flex-col grow">
              <p className="text-slate-600 text-lg mb-8 grow leading-relaxed">
                {grant.description}
              </p>
